...
enum SeerrClient {
    ...
    static func discoverStudioMovies(
        studioID: Int,
        page: Int = 1,
        language: String? = nil
    ) async -> Result<Page<MediaResult>, ProbeError> {
        await decode(
            ...
            failurePrefix: "Seerr discover studio movies failed"
        )
    }
    ...
    static func discoverNetworkTV(
        ...
        await decode(
            ...
            failurePrefix: "Seerr discover network TV failed"
        )
    }
