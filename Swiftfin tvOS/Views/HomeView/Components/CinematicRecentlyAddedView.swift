...
extension HomeView {
    ...
    struct CinematicRecentlyAddedView: View {
        ...
        private let maxHeroItemCount = 8
        ...
        private var items: [BaseItemDto] {
            Array(viewModel.elements.elements.prefix(maxHeroItemCount))
        }
        ...
        private func heroContent(for item: BaseItemDto) -> some View {
            CinematicItemHeroView(item: item) { itemViewModel in
                ...
                infoButton(viewModel: itemViewModel)
        ...
        private func favoriteButton(viewModel: ItemViewModel) -> some View {
        ...
        private func infoButton(viewModel: ItemViewModel) -> some View {
            Button {
                router.route(to: .item(item: viewModel.item))
            } label: {
        ...
        private func refreshDetailedSelectedItem() async {
            ...
            do {
                ...
                // Keep the lightweight recently added item if the full metadata request fails.
            }
        }
    }
}
